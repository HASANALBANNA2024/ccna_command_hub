...
//                   onPressed: () async {
//                     // ১. ইউজারকে ফিডব্যাক দিতে একটি লোডিং ইন্ডিকেটর দেখাতে পারেন (ঐচ্ছিক)
//
...
//
//                       // ২. mounted চেক: নিশ্চিত করা যে স্ক্রিনটি এখনো মেমরিতে আছে
//                       if (!mounted) return;
//
//                       try {
//                         // ক্লাউড থেকে ডাটা আনা
//                         await CloudSyncService().syncCloudToLocal();
//                         print("All progress restored from cloud.");
//                       } catch (e) {
//                         print("Sync Error: $e");
//                       }
//
//                       // ৩. ফাইনাল চেক: নেভিগেশন করার আগে আবার mounted চেক করা বাধ্যতামূলক
//                       if (mounted) {
